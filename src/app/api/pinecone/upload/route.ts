...
export async function POST(request: NextRequest) {
  ...
  try {
    ...
    const { pdfId, content, filename } = body;
    ...
    // Update PDF with Pinecone file ID
    await convex.mutation(api.pdfs.updateStatus, {
      id: pdfId as Id<"pdfs">,
      status: "processing",
